...
class GeoJsonFileManagerUseCase(
    private val centroDistribuicaoCRUDUseCase: LocalizablePlaceCRUDUseCase,
    private val geoJsonFilePublisherPort: GeoJsonFilePublisherPort
) {
        ...
        geoJsonUploadedFileDTO.featureCollection.features.forEach { oneFeature ->
            ...
            if (oneFeature.geometry is org.geojson.Point) {
                ...
                if (coordinates != null) {
                    ...
                    try {
                        centroDistribuicaoCRUDUseCase.cadastrar(nome, null, locationCoords)
